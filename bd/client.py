...
db_cliente=MongoClient("mongodb+srv://fabiancastrod:pSrwvhk6fDGK3iTJ@cluster0.opein.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0").usersfabauth 
